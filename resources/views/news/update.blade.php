                ...
                <form method="post" action="{{ url('/news/update') }}/{{$news->id}}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <input type="text" name="news_title" class="form-control" value="{{ old('news_title') ?? $news->title }}">
                        ...
                        <div class="col-12 mt-2">
                            ...
                            <textarea name="news_desc" required id="editor" class="form-control" cols="30" rows="10">{{ old('news_desc') ?? $news->description }}</textarea>
                            <span class="text-danger">
